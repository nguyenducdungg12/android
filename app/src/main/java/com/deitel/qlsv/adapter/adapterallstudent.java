...
public class adapterallstudent extends BaseAdapter {

    private ActivityShowAllStudent context;
    private ArrayList<Student> ArrayListStudent;

    public adapterallstudent(ActivityShowAllStudent context, ArrayList<Student> arrayListStudent) {
