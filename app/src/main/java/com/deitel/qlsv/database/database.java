...
public class database extends SQLiteOpenHelper {
    ...
    public boolean checkSubjectStudent(int id_student,int id_subject){
        ...
        Cursor cursor= db.rawQuery("SELECT * FROM "+TABLE_SUBJECTS +
                ...
                TABLE_SUBJECTS+"."+TIME+" IN (SELECT TIME FROM "+TABLE_SUBJECTS+" WHERE "+ID_SUBJECTS+" = "+id_subject+")"+" AND "+
                TABLE_SUBJECTS+"."+DAY+" IN (SELECT DAY FROM "+TABLE_SUBJECTS+" WHERE "+ID_SUBJECTS+" = "+id_subject+")"
                ,null);
