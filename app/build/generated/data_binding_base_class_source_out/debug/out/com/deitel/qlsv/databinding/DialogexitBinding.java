...
public final class DialogexitBinding implements ViewBinding {
  ...
  private DialogexitBinding(@NonNull LinearLayout rootView, @NonNull Button buttonNo,
  ...
  public static DialogexitBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialogexit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static DialogexitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogexitBinding((LinearLayout) rootView, buttonNo, buttonYes);
    }
